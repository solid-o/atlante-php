...
class UrlDecoratorTest extends TestCase
{
    ...
    {
        yield ['http://api.example.test', 'http://localhost/foo', 'http://api.example.test/foo'];
        yield ['https://api.example.com', 'http://localhost/foo', 'https://api.example.com/foo'];
        ...
        yield ['http://api.example.test/foo?test=1', '/foo', 'http://api.example.test/foo?test=1'];
        yield ['http://api.example.test/foo?test=1', '/foo?test=2&c=a', 'http://api.example.test/foo?test=2&c=a'];

        yield ['http://api.example.test/foo#frag', '/bar', 'http://api.example.test/foo/bar#frag'];
